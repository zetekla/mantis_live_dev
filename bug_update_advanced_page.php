...
echo '<link href="client/css/manextis.client.style.css" rel="stylesheet" />';
echo '<br />';
echo '<form name="update_bug_form" method="post" action="bug_update.php" ng-app="myApp">';
...
?>
	<tr <?php echo helper_alternate_class() ?>>
		...
		<td colspan="5">
			<input <?php echo helper_get_tab_index() ?> type="text" name="wono" size="32" maxlength="32" value="" ng-model='query'></input><span ng-show="query">Search for "{{query}}"</span>
		</td>
	</tr>
<?php	
# Custom Fields
...
if ( $t_custom_fields_found ) {
	# spacer
	echo '<result-fetch></result-fetch><tr class="spacer"><td colspan="6"></td></tr>';
} # custom fields found
...
if (ERP_bug_from_email( $f_bug_id )){
	...
	echo '<td colspan="5">';
	echo 'This issue was reported through A.R.T.E and can not have the description content edited.';
	echo '</td></tr>';
} else {
