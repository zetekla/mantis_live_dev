...
function user_create( $p_realname, $p_username, $p_password, $p_email = '',
...
# returns false if error, the generated cookie string if ok
function user_signup( $p_realname, $p_username, $p_email = null ) {
	if( null === $p_email ) {
		$p_email = '';
	...
	return user_create( $p_realname, $p_username, $t_password, $p_email );
}
